...
class ICalTimezoneGenerator {
  ...
  private function getFromTime($timezoneOffsetFrom) {
    ...
    //                 floor($timezoneOffsetFrom)) * 60);
       ...
       // We want to return a format like '-0400' and '+0400', but we get the '-'
    // automatically and have to add the '+' ourselves, so the padding is %02d
   // for positive and %03d for negative.
   if ($timezoneOffsetFrom >= 0) {
